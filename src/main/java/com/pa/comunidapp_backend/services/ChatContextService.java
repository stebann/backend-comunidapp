    ...
    public String obtenerContextoUsuario(Long usuarioId) {
        ...
        usuarioRepository.findById(usuarioId).ifPresent(usuario -> {
            ...
            contexto.append("Rating: ")
                    .append(usuario.getRatingPromedio() != null ? usuario.getRatingPromedio() : "Sin calificaciones")
                    .append("\n");
        });

        // Estadísticas de artículos
        long articulosPublicados = articuloRepository.countByUsuarioIdAndEliminadoEnIsNull(usuarioId);
        long articulosDisponibles = articuloRepository.countByUsuarioIdAndEstadoArticuloCodigoAndEliminadoEnIsNull(
                usuarioId, EEstadoArticulo.Disponible.getCodigo());
        long articulosPrestados = articuloRepository.countByUsuarioIdAndEstadoArticuloCodigoAndEliminadoEnIsNull(
